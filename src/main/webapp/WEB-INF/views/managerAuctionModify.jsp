                        ...
                        <div class="pageFixSize">
                            <div class="userInfo">
                                <div class="userNav">
                                    ...
                                    <ul>
                                        <li><a href="${pageContext.request.contextPath}/managerQuestion">1:1 문의 내역</a>
                                        </li>
                                        <li><a href="${pageContext.request.contextPath}/managerCommission">위탁 관리</a>
                                        </li>
                                        <li><a href="${pageContext.request.contextPath}/managerAuction"
                                                style="color: black; font-weight: 700;">경매 관리</a></li>
                                        <li><a href="${pageContext.request.contextPath}/managerAuctionRegist">경매 물품
                                                등록</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="auctionInfoInfo">
                                    ...
                                    <div class="auctionTabWrap">
                                        <div class="dateManagement"><a href="managerAuction">일정 관리</a></div>
                                        <div class="tab active modify">일정 수정</div>
                                    </div>

                                    <div class="dateModifyWrap">
                                        <hr>
                                        <form id="auctionForm" action="${pageContext.request.contextPath}/scheduleModify"
                                            method="post">
                                            <!-- 폼 안에 있는 기존 날짜 선택 필드들 -->
                                            <div class="startAuction">
                                                <p>경매 시작일</p>
                                                <!-- <c:out value="${auctionScheduleDTO.auctionSchedule_start}" /> -->
                                                <!-- <option value="${year}" <c:if test="${fn:substring(auctionScheduleDTO.auctionSchedule_start, 0, 4) eq year}">selected</c:if>>${year}</option> -->
                                                <div class="startYear">
                                                    <select name="auctionSchedule_startYear" id="startYear"
                                                        style="cursor: pointer;">
                                                        <option value=""></option>
                                                        <c:forEach begin="${currentYear}" end="${currentYear + 2}"
                                                            var="year">
                                                            <option value="${year}" <c:if
                                                                test="${fn:substring(auctionScheduleDTO.auctionSchedule_start, 0, 4) == year}">
                                                                selected</c:if>>${year}</option>
                                                        </c:forEach>
                                                    </select>
                                                    <p>년</p>
                                                </div>
                                                <div class="startMonth">
                                                    <select name="auctionSchedule_startMonth" id="startMonth"
                                                        ...
                                                        <c:forEach begin="1" end="12" var="month">
                                                            <option value="${month}" <c:if
                                                                test="${fn:substring(auctionScheduleDTO.auctionSchedule_start, 5, 7) == month}">
                                                                selected</c:if>>${month}</option>
                                                        </c:forEach>
                                                    </select>
                                                    <p>월</p>
                                                </div>
                                                    ...
                                                    <select name="auctionSchedule_startDay" id="startDay"
                                                        ...
                                                        <c:forEach begin="1" end="31" var="day">
                                                            <option value="${day}" <c:if
                                                                test="${fn:substring(auctionScheduleDTO.auctionSchedule_start, 8, 10) == day}">
                                                                selected</c:if>>${day}</option>
                                                        </c:forEach>
                                                    </select>
                                                    <p>일</p>
                                                </div>
                                            ...
                                            <div class="endAuction">
                                                ...
                                                <div class="endYear">
                                                    <select name="auctionSchedule_endYear" id="endYear"
                                                        ...
                                                        <c:forEach begin="${currentYear}" end="${currentYear + 2}"
                                                            var="year">
                                                            <option value="${year}" <c:if
                                                                test="${fn:substring(auctionScheduleDTO.auctionSchedule_end, 0, 4) == year}">
                                                                selected</c:if>>${year}</option>
                                                        </c:forEach>
                                                    </select>
                                                    <p>년</p>
                                                ...
                                                <div class="endMonth">
                                                    <select name="auctionSchedule_endMonth" id="endMonth"
                                                        ...
                                                        <c:forEach begin="1" end="12" var="month">
                                                            <option value="${month}" <c:if
                                                                test="${fn:substring(auctionScheduleDTO.auctionSchedule_end, 5, 7) == month}">
                                                                selected</c:if>>${month}</option>
                                                        </c:forEach>
                                                    </select>
                                                    <p>월</p>
                                                ...
                                                <div class="endDay">
                                                    <select name="auctionSchedule_endDay" id="endDay"
                                                        ...
                                                        <c:forEach begin="1" end="31" var="day">
                                                            <option value="${day}" <c:if
                                                                test="${fn:substring(auctionScheduleDTO.auctionSchedule_end, 8, 10) == day}">
                                                                selected</c:if>>${day}</option>
                                                        </c:forEach>
                                                    </select>
                                                    <p>일</p>
                                            ...
                                            <input type="hidden" name="auctionSchedule_id"
                                                value="${auctionScheduleDTO.auctionSchedule_id}">
                                            <hr>

                                            <!-- 등록 버튼을 통해 form 데이터 전송 -->
                                            <div class="dateModifyBtnWrap">
                                                <div class="cancel btn2">
                                                    <a href="managerAuction">
                                                        <p>취소</p>
                                                    </a>
                                                </div>
                                                <button type="submit" class="modify btn2">
                                                    <p>수정</p>
                                                </button>
                                            </div>

                                            <!-- hidden 필드에 조합된 날짜 값 저장 -->
                                            <input type="hidden" id="auctionSchedule_start"
                                                name="auctionSchedule_start">
            ...
            <script>
                $(document).ready(function () {
                    $('.tab').click(function () {
                        ...
                        $('.dateManagementWrap, .dateRegisterWrap, .dateModifyWrap').removeClass('active');
                        ...
                        if ($(this).hasClass('dateManagement')) {
                            ...
                            $('.dateModifyWrap').addClass('active');
                        }
                    });
                });
            </script>
