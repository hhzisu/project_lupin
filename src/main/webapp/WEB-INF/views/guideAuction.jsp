...
<%--                                </div>--%>
                ...
                <div class="board">
                    ...
                    <div class="content">
                        ...
                        <p>! 낙찰자는 낙찰을 철회할 수 없습니다. 부득이 철회를 하는 경우에는 낙찰일로부터 7일 이내에 서면으로 철회의사를 통보하고, 위약벌로 낙찰가의 30%에 해당하는 금액을 낙찰일로부터 7일 이내에 납부하여야 합니다.</p>
                        <br><h3>3. 구매 수수료</h3><br>
                ...
                <div class="board">
                    ...
                    <div class="content">
                        ...
                        <p>4. 작품수령 가능 요일, 시간 : 월요일 ~ 금요일(법정 공휴일 제외) / 당사 업무시간 9시 ~ 18시 (점심시간 12시~13시 제외.)</p>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;낙찰자 승용차에 작품 상차시 참고 : 작품 전체 크기 90 * 118cm까지 가능함(캔버스 50호 크기)</p><br>
